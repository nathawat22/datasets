...
CONTROL_FOLDER = 'dementia/English/Pitt/Control/cookie'
DEMENTIA_FOLDER = 'dementia/English/Pitt/Dementia/cookie'
LABELS = ['dementia', 'control']
...
class Dementiabank(tfds.core.GeneratorBasedBuilder):
  ...
  """.format(CONTROL_FOLDER, DEMENTIA_FOLDER)
  ...
  def _split_generators(self, dl_manager):
    ...
    control_folder = os.path.join(dl_manager.manual_dir, CONTROL_FOLDER)
    dementia_folder = os.path.join(dl_manager.manual_dir, DEMENTIA_FOLDER)
